...
! function(e, t) {
    ...
    function ub(e, t, r, n, o, i, a, s) {
        ...
        return x += "position:" + ((h || s) && g ? "fixed;" : "absolute;"), !h && !s && g || (x += (n === Je ? S : T) + ":" + (i + parseFloat(f)) + "px;"),
                    ...
                    if (ct(_e),
                        ...
                        oe && (!1 === ie || ie === kt || (ie = !(!ie && "flex" === db(oe.parentNode).display) && Tt),
                            ...
                            (n = qe.core.getCache(oe)).spacer ? R = n.pinState : (l && ((l = I(l)) && !l.nodeType && (l = l.current || l.nativeElement),
                                ...
                                n.pinState = R = Yb(oe)), !1 !== S.force3D && qe.set(oe, {
                                force3D: !0
                            }),
                    ...
                    _e.previous = function() {
                            ...
                            if (!ot && _e.enabled || t)
                                if (oe && e && ht)
                                    ...
                                    for (var r, n, o, i, a, s, l, c, u, f, d = Te(), p = ke(), g = fe ? fe.duration() : Ha(ve, ge), h = 0, v = 0, b = S.end, m = S.endTrigger || ne, y = S.start || (0 !== S.start && ne ? oe ? "0 0" : "0 100%" : 0), x = _e.pinnedContainer = S.pinnedContainer && I(S.pinnedContainer), w = ne && Math.max(0, Pt.indexOf(_e)) || 0, _ = w; _--;)
                                        (s = Pt[_]).end || s.refresh(0, 1) || (ot = 1), !(l = s.pin) || l !== ne && l !== oe || s.isReverted || ((f = f || []).unshift(s),
                                            s.revert(!0, !0)),
                                        s !== Pt[_] && (w--,
                                            _--);
                                    for (Ka(y) && (y = y(_e)),
                                    ...
                                    if (M += h,
                                        ...
                                        i = ge === Je,
                                        o = Me(),
                                        K = parseFloat(X(ge.a)) + v, !g && 1 < O && ((be ? et : ve).style["overflow-" + ge.a] = "scroll"),
                                        Vb(oe, F, r),
                                        L = Yb(oe),
                                        n = Mt(oe, !0),
                                        c = me && J(ve, i ? He : Je)(),
                        ...
                        _e.enable = function(e, t) {
                            _e.enabled || (_e.enabled = !0,
                                ...
                                Se && nb(ScrollTrigger, "refreshInit", Se), !1 !== e && (_e.progress = j = 0,
                                    A = E = Ae = Me()), !1 !== t && _e.refresh())
                        },
                        ...
                        _e.disable = function(e, t) {
                            if (_e.enabled && (!1 !== e && _e.revert(!0, !0),
                                    ...
                                    q && (q.pause(),
                                        k.tween && k.tween.kill() && (k.tween = 0)), !be)) {
